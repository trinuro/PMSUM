    ...
    return (<section className='relative'>
        ...
        <div className='max-container padding-container relative py-10'>
            ...
            <div className='flexCenter'>
                <p className='text-center pb-5 max-w-[800px] text-[24px] lg:text-[32px]'>{OBJECTIVES_TEXT}</p>
            </div>
...
const dayak_strip = (position:string) =>{
    return(
        <div className={'absolute bg-dayak-motif-2 h-full w-28 top-0 bg-center -z-10 opacity-20 '+position}></div>
    )
}
...
const objective_card = (index:Number, content:String) =>{
    return (
        <section key={`objective-${index}`} className='bg-yellow-dark max-w-[310px] rounded-md lg:rounded-lg'>
            <div className='py-2 relative'>
                <div className='bg-dayak-motif w-full h-full bg-center opacity-20 z-10 absolute top-0 left-0'></div>
