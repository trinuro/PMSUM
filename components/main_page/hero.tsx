    ...
    return (<section className="bg-hero-bg h-screen relative -mt-[80px]">
        ...
        <section className="flex max-container padding-container justify-between pt-36">
            <div className="font-extrabold z-20 [text-shadow:_0_5px_2px_rgb(0_0_0_/_40%)]">
                ...
                <h1 className="text-yellow-dark text-[32px] leading-[120%] md:text-[70px] lg:text-[114px]">BY SARAWAKIANS</h1>
                <h1 className="text-red-dark text-[30px] leading-[120%] md:text-[66px] lg:text-[107px]">FOR SARAWAKIANS</h1>
