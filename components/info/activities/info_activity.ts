export const slideshow = {
  // Slideshow component [image source, title, subtitle]
  slide: [
...
export const activity_list = {
  ...
  list: [
    ...
    [{
      title: "Diskusi Belanjawan Sarawak 2024",
      page_url: "activities/2024/dbs2024"
    }],
  ],
}
...
export const act3 = {
  // Cover component
  video_src: "/image/activities/act3/vid_act3_0.mp4",
  video_url: "https://www.instagram.com/reel/C-o0uTlvtk-/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==",
  // Banner component
  banner_image_source: "/image/activities/act3/img_act3_0.png",
  // Title component
  title: "Fedaralisme",
  subtitle: "2024",
    ...
    content: [
      {
        ...
        content: [
          "Sistem federalisme di Malaysia merupakan asas kepada struktur pentadbiran negara. Sistem ini memastikan keseimbangan kuasa dan kerjasama antara dua peringkat kerajaan, membolehkan negeri-negeri mengekalkan identiti dan autonomi mereka sambil menyumbang kepada kestabilan dan kemakmuran negara secara keseluruhan.",
          "Infografik ini memberikan gambaran asas mengenai pembahagian kuasa dalam sistem federalisme di Malaysia, serta bagaimana ia mempengaruhi kehidupan rakyat di setiap negeri.",
...
export const act2 = {
  ...
  infographic: {
    ...
    content: [
      ...
      {
        content: [
          "💫Adakah anda seorang yang berbakat dalam bidang nyanyian ?",
          "Andalah yang kami cari ‼️‼️",
      ...
      {
        content: [
          "💫Adakah anda seorang yang berbakat dalam bidang seni?",
          "Andalah yang kami cari ‼️‼️",
