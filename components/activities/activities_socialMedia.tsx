...
import { latest_insta_post } from './activities_info'

const activities_socialMedia = (props: any) => {
  return (
    <div className="bg-cover bg-center" style={{ backgroundImage: "url(" + latest_insta_post.instagram_bg_image + ")" }}>
        ...
        <div className='w-full flexCenter'>
          ...
          <div className='w-full flexCenter my-10 md:my-0'>
            <div style={{ display: 'flex', justifyContent: 'center' }}>
              <InstagramEmbed url={"https://www.instagram.com/p/" + latest_insta_post.instagram_id} height={420} />
            </div>
          </div>
        </div>
      </div>
